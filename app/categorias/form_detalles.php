...
$con->query = "SELECT * FROM tbl_categorias WHERE id_categoria = $id";
$dt_categoria = $con->get_records();
$nombre = $dt_categoria[0]['nombre'];
...
<body>
    ...
    <div class="container-fluid" style="padding-top: 10px;">
        <div class="d-flex align-items-center mb-3">
            <div>
                <h4 class="page-header">Módulo Categorias</h4>
            </div>
            <div class="ms-auto">
        ...
        <div class="card text-dark bg-light mb-3 card-shadow">
            <div class="card-header"><strong>Detalles de la Categoria</strong></div>
            <div class="card-body">
                <div class="row mb-3">
