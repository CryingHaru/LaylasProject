...
<body>
  ...
  <div class="container-fluid" style="padding-top: 10px;">
    <div class="d-flex align-items-center mb-3">
      <div>
        <h4 class="page-header">Módulo de Clientes</h4>
      </div>
      <div class="ms-auto">
    ...
    <div class="card text-dark bg-light mb-3 card-shadow">
      <div class="card-header"><strong>Listado de clientes</strong></div>
      <div class="card-body">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              foreach ($paginador->registros_pagina as $cliente) {
                ...
                echo "<td>
                          <a style='color:white;' href='form_detalles.php?id=" . $cliente['id_cliente'] . "' class='btn btn-info'><i class='bi bi-eye-fill'></i> Detalles</a>
                      </td>";
                echo "</tr>";
              }
              ?>
